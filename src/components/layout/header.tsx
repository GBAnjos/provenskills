...
import { Shield, Search, Menu, X, LogOut, User, Settings } from "lucide-react";
        ...
        <div className="hidden md:flex md:items-center md:gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="h-9 w-48 rounded-lg border border-border bg-card pl-9 pr-3 text-sm placeholder:text-muted focus:border-[var(--proven-green-500)] focus:outline-none focus:ring-1 focus:ring-[var(--proven-green-500)]"
            />
          </div>
